...
_Alternativamente (3. e 4.)_, se você não quiser que a chave privada fique online, é possível gerar a chave STARK de forma segura com as seguintes etapas a fim de se obter as credenciais necessárias.

a. A partir da exchange dYdX Perpetuals, clique com o botão direito em qualquer lugar do seu navegador e selecione Inspecionar para abrir as Ferramentas de desenvolvedor
