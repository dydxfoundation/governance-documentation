...
1. Conecta tu billetera preferida de Ethereum al protocolo Perpetual de dYdX L2.
2. Deposita $USDC en tu cuenta Perpetual.
...
Como alternativa, los traders programáticos pueden obtener su par de claves STARK utilizando el siguiente método:
...
b. Ir a Aplicación > Almacenamiento local > https://trade.dydx.exchange
