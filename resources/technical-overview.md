...
| Merkle-Pauser 执行器 | 0xd98e7A71BacB6F11438A8271dDB2EFd7f9361F52 |
| Starkware 时间锁执行器 | 0xa306989BA6BcacdECCf3C0614FfF2B8C668e3CaE |
...
| Merkle 分配器  | 0x01d3348601968aB85b4bb028979006eac235a588 |
| Chainlink 适配器  | 0x99B0599952a4FD2d1A1561Fa4C010827EaD30354 |
| 流动性质押 | 0x5Aa653A076c1dbB47cec8C1B4d152444CAD91941 |
| 申领代理  | 0x0fd829C3365A225FB9226e75c97c3A114bD3199e |
| StarkEx Helper 治理者  | 0x0db9b3F7Dd83e29C9bece8E5e1089bA4369E694a |
| StarkEx Remover 治理者  | 0x3f129162087DbDf50F28246610e085cBf3a04012 |
| 奖励资金库代理管理 | 0x40D6992cbd03E0DC1c2DE9606D29Cb245E737a5d |
| 社区资金库代理管理 | 0x9d51599A6b10f562619D8ef2EFDcA1B68aE80D03 |
| 保险模块代理管理 | 0x6aaD0BCfbD91963Cf2c8FB042091fd411FB05b3C |
| Merkle 分配器代理管理 | 0x6C5cd3aD7A16Ae207D221908E6b997d9B0DcD7b0 |
...
| StarkProxy 代理管理 \[0\] | 0xE16718eace44e0CB06b9cd164490A69A6425D1e3 |
| StarkProxy 代理管理 \[1\] | 0x78e899e576C3565C3219dbC9Ea5042A9DBed36d3 |
| StarkProxy 代理管理 \[2\] | 0x15774D4555fEfD57C9Fc8b11C8beba993eafcc13 |
| StarkProxy 代理管理 \[3\] | 0x4d9460e5C958f46a1Fe129954A069a37972f16EA |
| StarkProxy 代理管理 \[4\] | 0xfa45DCDbEc82C94082d283B62506320DB8632054 |
{% endtab %}
{% endtabs %}
...
![流动性模块图表](../.gitbook/assets/image%20%2872%29.png)
...
TreasuryVester合约受到[Uniswap](https://github.com/Uniswap/governance/blob/master/contracts/TreasuryVester.sol)的启发。dYdX团队作了微小变更。

DydxEcosystemReserve合约受到Aave的启发。dYdX团队作了微小变更。

短时间锁只能执行治理批准的操作。

有两种资金质押方和生态系统储备合约，一种是流动性挖矿奖励，另一种是持有“普通用途”资金库资金。

由于治理控制每个生态系统储备区，它可以将资金转移到任何地址，并/或批准任何地址在任一生态系统储备区中使用资金。例如，奖励计划需要由治理设定的代币批准限额。

每个资金库质押方将向相应的生态系统储备区提供代币\（从资金库归属者部署器指定的时间戳和排放率开始\）。

生态系统储备区控制器仅是必要的，因为生态系统储备区智能合约是代理。治理是生态系统储备区的管理员，代理管理员不能调用代理的执行合约。因此，治理不能直接将功能调用给生态系统储备区，并需要生态系统储备区控制器“代理”对生态系统储备区执行合约的所有调用。

![社区资金库架构](../.gitbook/assets/image%20%2882%29.png)
