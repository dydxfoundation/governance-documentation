...
Существует 5 смарт-контрактов, которые поддерживают управление dYdX:
...
{% tabs %}
 ...
 | Исполнитель Starkware с правом на блокировку по времени | 0xa306989BA6BcacdECCf3C0614FfF2B8C668e3CaE |
 ...
 | Управляющий удалением StarkEx  | 0x3f129162087DbDf50F28246610e085cBf3a04012 |
 | Администрирование доверенности казны наград | 0x40D6992cbd03E0DC1c2DE9606D29Cb245E737a5d |
 | Администрирование доверенности дистрибьютора Меркла | 0x9d51599A6b10f562619D8ef2EFDcA1B68aE80D03 |
...
Контракт на токен DYDX развернут в основной сети Ethereum по адресу [0x92D6C1e31e14520e676a687F0a93788B716BEff5](https://etherscan.io/address/0x92d6c1e31e14520e676a687f0a93788b716beff5). Он был создан благодаря одобренному изменению \[ожидается в ближайшее время\].
...
Контракт управляющего развернут в основной сети Ethereum по адресу [0x7E9B1672616FF6D6629Ef2879419aaE79A9018D2](https://etherscan.io/address/0x7e9b1672616ff6d6629ef2879419aae79a9018d2). Он был создан благодаря одобренному изменению \[ожидается в ближайшее время\].
...
**Контракт на длительную блокировку по времени** развернут в основной сети Ethereum по адресу [0xEcaE9BF44A21d00E2350a42127A377Bf5856d84B](https://etherscan.io/address/0xecae9bf44a21d00e2350a42127a377bf5856d84b). Он был создан благодаря одобренному изменению \[ожидается в ближайшее время\].

**УКАЗАТЬ**

\[ожидается в ближайшее время\]

**Контракт на короткую блокировку по времени** развернут в основной сети Etherium по адресу [0xEcaE9BF44A21d00E2350a42127A377Bf5856d84B](https://etherscan.io/address/0xecae9bf44a21d00e2350a42127a377bf5856d84b). Он был создан благодаря одобренному изменению \[ожидается в ближайшее время\].

**УКАЗАТЬ**

\[ожидается в ближайшее время\]

**Контракт на блокировку дерева Меркла по времени** развернут в основной сети Etherium по адресу [0xd98e7A71BacB6F11438A8271dDB2EFd7f9361F52](https://etherscan.io/address/0xd98e7a71bacb6f11438a8271ddb2efd7f9361f52). Он был создан благодаря одобренному изменению \[ожидается в ближайшее время\].

**УКАЗАТЬ**

\[ожидается в ближайшее время\]

**Контракт на приоритетную блокировку по времени Starkware** развернут в основной сети Etherium по адресу [0xa306989BA6BcacdECCf3C0614F2B8C668e3CaE](https://etherscan.io/address/0xa306989ba6bcacdeccf3c0614fff2b8c668e3cae). Он был создан благодаря одобренному изменению \[ожидается в ближайшее время\].
...
Смарт-контракт дистрибьютора Меркла был вдохновлен проектами Uniswap и Badger. Смарт-контракт развернут в основной сети Ethereum по адресу 0x01d3348601968aB85b4bb028979006eac235a588. Он был создан благодаря одобренному изменению \[ожидается в ближайшее время\].
...
![Диаграмма модуля ликвидности](../.gitbook/assets/image%20%2872%29.png)
...
Контракт на вестинг казны был вдохновлен протоколом [Uniswap](https://github.com/Uniswap/governance/blob/master/contracts/TreasuryVester.sol). Специалисты dYdX внесли в него незначительные изменения.

Контракт на резерв экосистемы DYDX был вдохновлен протоколом Aave. Специалисты dYdX внесли в него незначительные изменения.

Контракт на короткую блокировку по времени может выполнять только те действия, что утверждены управлением.

Контракты на вестинг казны, предназначены для распределения наград за майнинг ликвидности, а контракты на резерв экосистемы — для хранения средств казны общего назначения.

Поскольку управление контролирует каждый резерв экосистемы, оно может переводить средства на любой адрес и/или позволять какому-либо адресу расходовать средства в рамках любого резерва экосистемы. Например, управление должно будет установить лимиты для токенов в рамках программ вознаграждения.

Каждый контракт на вестинг казны будет осуществлять вестинг токенов \(начиная с метки времени и скорости создания токенов, указанных пользователем, размещающим контракт на вестинг казны\) в соответствующий резерв экосистемы.

Контролер резерва экосистемы необходим только потому, что смарт-контракт на резерв экосистемы — это доверенность. Управление представляет собой администратора доверенности резерва экосистемы, но администраторы доверенности не могут вызывать исполняющий контракт доверенностей. Поэтому управление не может напрямую вызывать функции для резерва экосистемы, и от контролера резерва экосистемы требуется доверять все вызовы исполняющему контракту резерва экосистемы.

![Архитектура казны сообщества](../.gitbook/assets/image%20%2882%29.png)



## Периферийные контракты

### Система вознаграждения Chainlink на базе оракула \(награды за торговлю и для поставщиков ликвидности\)
