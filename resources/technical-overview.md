...
dYdX 거버넌스를 지원하는 5개의 스마트 컨트랙트가 있습니다.
...
{% tabs %}
{% tab title="메인넷" %} | 계약 | 주소 | | :--- | :--- | | DydxToken | 0x92D6C1e31e14520e676a687F0a93788B716BEff5 | | DydxGovernor | 0x7E9B1672616FF6D629Ef2879419aaE79A9018D2 | | 단기 타임락 실행자 | 0x64c7d40c07EFAbec2AafdC243bF59eaF2195c6dc | | 장기 타임락 실행자 | 0xEcaE9BF44A21d00E2350a42127A377Bf5856d84B | | 머클-포저 실행자 | 0xd98e7A71BacB6F11438A8271dDB2EFd7f9361F52 | | 스타크웨어 타임락 실행자 | 0xa306989BA6BcacdECCf3C0614FfF2B8C668e3CaE | | 보상 트레저리 | 0x639192D54431F8c816368D3FB4107Bc168d0E871 | | 커뮤니티 트레저리 | 0xE710CEd57456D3A16152c32835B5FB4E72D9eA5b | | 안전 모듈 | 0x65f7BA4Ec257AF7c55fd5854E5f6356bBd0fb8EC | | 거버넌스 전략 | 0x90Dfd35F4a0BB2d30CDf66508085e33C353475D9 | | 보상 트레저리 베스터 | 0xb9431E19B29B952d9358025f680077C3Fd37292f | | 커뮤니티 트레저리 베스터 | 0x08a90Fe0741B7DeF03fB290cc7B273F1855767D8 | | 머클 배포자 | 0x01d3348601968aB85b4bb028979006eac235a588 | | 체인링크 어댑터 | 0x99B0599952a4FD2d1A1561Fa4C010827EaD30354 | | 유동성 스테이킹 | 0x5Aa653A076c1dbB47cec8C1B4d152444CAD91941 | | 클레임 프록시 | 0x0fd829C3365A225FB9226e75c97c3A114bD3199e | | StarkEx 도움말 거버너 |  0x0db9b3F7Dd83e29C9bece8E5e1089bA4369E694a | | StarkEx 리무버 거버너 | 0x3f129162087DbDf50F28246610e085cBf3a04012 | | 보상 트레저리 프록시 관리자 | 0x40D6992cbd03E0DC1c2DE9606D29Cb245E737a5d | | 커뮤니티 트레저리 프록시 관리자 | 0x9d51599A6b10f562619D8ef2EFDcA1B68aE80D03 | | 안전 모듈 프록시 관리자 | 0x6aaD0BCfbD91963Cf2c8FB042091fd411FB05b3C | | 머클 배포자 프록시 관리자 | 0x6C5cd3aD7A16Ae207D221908E6b997d9B0DcD7b0 | | 유동성 스테이킹 프록시 관리자 | 0xAc5D8bCD13da463bea96c75f9085c4e40037F790 |
| StarkProxy \[0\] | 0x0b2B08AC98a1568A34208121c26F4F41a9e0FbB6 | | StarkProxy \[1\]  | 0x3e6E9EFb0A677a24F47093a22044dc5451A028cF | | StarkProxy \[2\]  | 0xCB7fa3a2F47b62293Cc2E1a4C7752fC72E49FCe2 | | StarkProxy \[3\]  | 0x16BEC2D9A010e7D8b2D576d17893C52Ddbfe4C06 | | StarkProxy \[4\]  | 0x531F3BE462F10386D01FBeD7fAD1d20A61Ce7874 | | StarkProxy 프록시 관리자 \[0\] | 0xE16718eace44e0CB06b9cd164490A69A6425D1e3 | | StarkProy 프록시 관리자 \ [1]] | 0x78e899e576C3565C3219dbC9Ea5042A9DBed36d3 | | StarkProy 프록시 관리자 \ [2\] | 0x15774D4555fEfD57C9Fc8b11C8beba993eafcc13 | | StarkProy 프록시 관리자 \ [3\] | 0x4d9460e5C958f46a1Fe129954A069a37972f16EA | | StarkProy 프록시 관리자 \ [4\] | 0xfa45DCDbEc82C94082d283B62506320DB8632054 | {% endtab %} {% endtabs %}
...
![유동성 모듈의 다이어그램](../.gitbook/assets/image%20%2872%29.png)
...
TreasuryVeser 계약은 [Uniswap](https://github.com/Uniswap/governance/blob/master/contracts/TreasuryVester.sol)에서 영감을 받았습니다. dYdX 팀에 의해 작은 변경 사항이 있습니다.

DydxEcosystemReserve 계약은 Aave에서 영감을 받았습니다. dYdX 팀에 의해 작은 변경 사항이 있습니다.

단기 타임락은 거버넌스에 의해 승인된 활동만 수행할 수 있습니다.

2개의 트레저리 베스터 및 생태계 리저브 계약이 있습니다. 하나는 유동성 채굴 보상을 위한 것이고 다른 하나는 일반적으로 트레저리 자금을 보유하기 위한 것입니다.

거버넌스는 각 생태계 리저브를 통제하기 때문에 자금을 임의의 주소로 이체하거나 생태계 리저브 내에서 자금을 지출하기 위해 모든 주소를 승인할 수 있습니다. 예를 들어 보상 프로그램에는 거버넌스에 의해 설정된 토큰 승인 제한이 있어야 합니다.

각 트레저리 베스터는 토큰을 해당 생태계 리저브에 정해진 타임스탬프와 배출률에 따라 귀속시킵니다.

생태계 리저브 컨트롤러는 단지 생태계 리저브 스마트 컨트랙트가 프록시이기 때문에 필요합니다. 거버넌스는 생태계 리저브 프록시의 관리자이며 프록시 관리자는 프록시의 구현 계약을 호출할 수 없습니다. 따라서 거버넌스는 생태계 리저브 기능을 직접 호출할 수 없으며 생태계 리저브 구현 계약에 대한 모든 호출을 "프록시"하기 위해 생태계 리저브 컨트롤러가 필요합니다.

![커뮤니티 트레저리 아키텍처](../.gitbook/assets/image%20%2882%29.png)
