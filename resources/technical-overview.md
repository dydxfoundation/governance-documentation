...
dYdX Governanceをサポートするのは5つのスマートコントラクトです。
...
| ショートタイムロックの実行管理者 | 0x64c7d40c07EFAbec2AafdC243bF59eaF2195c6dc |
| ロングタイムロックの実行管理者 | 0xEcaE9BF44A21d00E2350a42127A377Bf5856d84B |
| Merkle-Pauserの実行管理者 | 0xd98e7A71BacB6F11438A8271dDB2EFd7f9361F52 |
| Starkwareのタイムロックの実行管理者 | 0xa306989BA6BcacdECCf3C0614FfF2B8C668e3CaE |
| 報酬基金 | 0x639192D54431F8c816368D3FB4107Bc168d0E871 |

| コミュニティ基金 | 0xE710CEd57456D3A16152c32835B5FB4E72D9eA5b |
| セーフティモジュール | 0x65f7BA4Ec257AF7c55fd5854E5f6356bBd0fb8EC |
| ガバナンス戦略 | 0x90Dfd35F4a0BB2d30CDf66508085e33C353475D9 |
| 報酬基金ベスター  | 0xb9431E19B29B952d9358025f680077C3Fd37292f |
| コミュニティ基金ベスター  | 0x08a90Fe0741B7DeF03fB290cc7B273F1855767D8 |
| Merkleディストリビューター  | 0x01d3348601968aB85b4bb028979006eac235a588 |
| チェーンリンクアダプター  | 0x99B0599952a4FD2d1A1561Fa4C010827EaD30354 |
...
| StarkExリムーバーガバーナー  | 0x3f129162087DbDf50F28246610e085cBf3a04012 |
| 報酬基金のプロキシ管理者  | 0x40D6992cbd03E0DC1c2DE9606D29Cb245E737a5d |
| コミュニティ基金のプロキシ管理者 | 0x9d51599A6b10f562619D8ef2EFDcA1B68aE80D03 |
| 安全性モジュールのプロキシ管理者 | 0x6aaD0BCfbD91963Cf2c8FB042091fd411FB05b3C |
| Merkleディストリビューターのプロキシ管理者 | 0x6C5cd3aD7A16Ae207D221908E6b997d9B0DcD7b0 |
| 流動性ステーキングのプロキシ管理者 | 0xAc5D8bCD13da463bea96c75f9085c4e40037F790 |
...
DYDXは、イーサリアムメインネットの[0x92D6C1e31e14520e676a687F0a93788B716BEff5](https://etherscan.io/address/0x92d6c1e31e14520e676a687f0a93788b716beff5)にデプロイされています。コミットから構築されました\[近日公開\]。
...
ガバナーは、イーサリアムメインネットの[0x7E9B1672616FF6D6629Ef2879419aaE79A9018D2](https://etherscan.io/address/0x7e9b1672616ff6d6629ef2879419aae79a9018d2)にデプロイされています。コミットから構築されました\[近日公開\]。
...
**ロングタイムロック**は、イーサリアムメインネットの[0xEcaE9BF44A21d00E2350a42127A377Bf5856d84B](https://etherscan.io/address/0xecae9bf44a21d00e2350a42127a377bf5856d84b)にデプロイされています。コミットから構築されました\[近日公開\]。

**ABI**

\[近日公開\]

**ショートタイムロック**は、イーサリアムメインネットの[0xEcaE9BF44A21d00E2350a42127A377Bf5856d84B](https://etherscan.io/address/0xecae9bf44a21d00e2350a42127a377bf5856d84b)にデプロイされています。コミットから構築されました\[近日公開\]。

**ABI**

\[近日公開\]

**Merkleタイムロック**は、イーサリアムメインネットの[0xd98e7A71BacB6F11438A8271dDB2EFd7f9361F52](https://etherscan.io/address/0xd98e7a71bacb6f11438a8271ddb2efd7f9361f52)にデプロイされています。コミットから構築されました\[近日公開\]。

**ABI**

\[近日公開\]

**Starkwareのプライオリティタイムロック**は、イーサリアムメインネットの[0xa306989BA6BcacdECCf3C0614FfF2B8C668e3CaE](https://etherscan.io/address/0xa306989ba6bcacdeccf3c0614fff2b8c668e3cae)にデプロイされています。コミットから構築されました\[近日公開\]。
...
Merkleディストリビューターのスマートコントラクトは、UniswapおよびBadgerのデザインにインスパイアされました。スマートコントラクトは、イーサリアムメインネットの0x01d3348601968aB85b4bb028979006eac235a588にデプロイされています。コミットから構築されました\[近日公開\]。
...
![流動性モジュールの図](../.gitbook/assets/image%20%2872%29.png)
...
TreasuryVester契約は、[Uniswap](https://github.com/Uniswap/governance/blob/master/contracts/TreasuryVester.sol)によりインスパイアされました。dYdXチームによってマイナーな変更が行われました。

DydxEcosystemReserve契約はAaveによりインスパイアされました。dYdXチームによってマイナーな変更が行われました。

ショートタイムロックでは、ガバナンスで承認されたアクションのみ実行できます。

2つの資金調達ベスターおよびエコシステム準備金に関する契約が存在し、1つは流動性マイニング報酬、もう1つは「一般目的」の基金の保有に関する契約です。

ガバナンスは各エコシステム準備金を管理しているため、資金を任意のアドレスに振り替えたり、いずれかのエコシステム準備金を支出するアドレスを承認したりすることができます。たとえば、ガバナンスは報酬プログラムにトークンの承認制限を設定する必要があります。

各資金調達ベスターは、対応するエコシステム準備金にトークンを保有します \（資金調達ベスターのデプロイヤが指定するタイムスタンプおよびエミッション率から開始\）。

エコシステム準備金の管理者は、エコシステム準備金スマートコントラクトがプロキシである場合にのみ必要です。ガバナンスはエコシステム準備金プロキシの管理者であり、プロキシ管理者はプロキシの実装契約を呼び出すことはできません。したがって、ガバナンスはエコシステム準備金の関数を直接呼び出すことはできず、エコシステム準備金管理者にエコシステム準備金実装契約へのすべての呼び出しを「プロキシ」させる必要があります。

![コミュニティ基金アーキテクチャ](../.gitbook/assets/image%20%2882%29.png)
