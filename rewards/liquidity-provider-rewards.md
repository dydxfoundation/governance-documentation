...
초기 토큰 공급의 7.5%(`75,000,000 DYDX`)는 가동시간, 양방향 호가, 매수가와 매도가의 차이 및 지원 시장 수의 조합을 보상하는 공식을 기반으로 유동성 제공자에게 할당됩니다.
