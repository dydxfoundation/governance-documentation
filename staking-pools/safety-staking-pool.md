...
`2,50%` от первоначального количества токенов в обращении (`25 000 000 DYDX`) будет распределено между пользователями, размещающими DYDX в пуле безопасности, для технической поддержки системы.
...
* Финансовая устойчивость биржи (например, снижение уровня залоговой обеспеченности биржи в связи с убыточной ликвидацией)
