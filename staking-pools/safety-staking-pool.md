...
La pool de sécurité sera mis en ligne lorsque DYDX deviendra transférable le 8 septembre 2021, 15 h 00 UTC.
...
### Comment puis-je déposer et staker DYDX sur la pool de sécurité ?
...
Un staker peut avoir une combinaison de soldes actifs et inactifs. Les fonds sont comptabilisés epoch par epoch, comme illustré dans l'exemple suivant :
...
* Les stakers qui demandent de retirer DYDX au moins 14 jours avant la fin de l'epoch en cours peuvent retirer leur DYDX au début de l'epoch suivante.
...
La décision d'un staker de verrouiller DYDX dans la pool de sécurité l'expose au risque d'un événement de pénurie, ce qui peut entraîner la réduction des fonds DYDX stakés à la discrétion de la gouvernance de DYDX.
