...
* **50.00%** (`500,000,000 DYDX`) a la comunidad de la siguiente manera:
  ...
  * **2,50 %** (`25,000.000 DYDX`) a los usuarios que inviertan USDC en un fondo de participación de liquidez ([**módulo de**](../staking-pools/liquidity-staking-pool.md) liquidez). En [DIP 14](https://github.com/dydxfoundation/dip/blob/master/content/dips/DIP-14.md)1, la comunidad dYdX [votó](https://dydx.community/dashboard/proposal/7) para establecer las recompensas asociadas con la participación de USDC en 0. Los 383,562 DYDX distribuidos previamente a los participantes de USDC se acumularán en el Tesoro de Recompensas y la comunidad dYdX podrá utilizarlos con un [voto de gobernanza](https://docs.dydx.community/dydx-governance/voting-and-governance/governance-parameters).
...
Sí, la comunidad dYdX puede cambiar cualquiera de [las recompensas y grupos existentes en el lanzamiento](../voting-and-governance/governance-parameters.md). Hasta ahora, la comunidad dYdX ha votado para reducir las recompensas comerciales en un 25 % y establecer recompensas por invertir USDC en 0.
