...
Foi realizado o mint de um total de `1.000.000.000 de $ethDYDX` em **3 de agosto de 2021, às 15:00:00 UTC**, e começou a se tornar acessível ao longo de cinco (5) anos. A alocação inicial de cinco anos do fornecimento total de $ethDYDX foi a seguinte:
...
* **50,0%** (`500.000.000 $ethDYDX`) para a comunidade da seguinte forma:
  ...
  * **0,5%** (`5.289.939 $ethDYDX`) para usuários fazendo staking de $ethDYDX em um [pool de staking de segurança](https://docs.dydx.community/dydx-governance/staking-pools/safety-staking-pool),
    * Na [DIP 17](https://github.com/dydxfoundation/dip/blob/master/content/dips/DIP-17.md), a comunidade dYdX [votou](https://dydx.community/dashboard/proposal/9) para definir as recompensas associadas ao staking de $ethDYDX para 0. Os 383.562 $ethDYDX anteriormente distribuídos aos stakers de $ethDYDX serão acumulados no Tesouro de Recompensas e poderão ser usados pela comunidade dYdX com um [voto de governança](https://docs.dydx.community/dydx-governance/voting-and-governance/governance-parameters).
* **27,7%** (`277.295.070 $ethDYDX`) para antigos investidores da dYdX Trading Inc.,
* **15,3%** (`152.704.930 ethDYDX`) para fundadores, funcionários, conselheiros e assessores da dYdX Trading Inc. ou dYdX Foundation, e
* **7,0%** (`70.000.000 $ethDYDX`) para futuros funcionários e consultores da dYdX Trading Inc. ou dYdX Foundation.
...
*  No [DIP 14](https://github.com/dydxfoundation/dip/blob/master/content/dips/DIP-14.md), a comunidade dYdX [votou](https://dydx.community/dashboard/proposal/7) pela definição das recompensas associadas ao $USDC em staking para 0. O valor 383.562 $ethDYDX anteriormente distribuídos para stakers de $USDC ficará acumulado no Tesouro de Recompensas e poderá ser usado pela comunidade dYdX com um [voto de governança](https://docs.dydx.community/dydx-governance/voting-and-governance/governance-parameters).
* Na [DIP 17](https://github.com/dydxfoundation/dip/blob/master/content/dips/DIP-17.md), a comunidade dYdX [votou](https://dydx.community/dashboard/proposal/9) para definir as recompensas associadas ao staking de $ethDYDX em 0. Os 383.562 $ethDYDX anteriormente distribuídos aos stakers de $DYDX serão acumulados no Tesouro de Recompensas e poderão ser usados pela comunidade dYdX com um vo[to de governança.](https://docs.dydx.community/dydx-governance/voting-and-governance/governance-parameters)
...
Parte da alocação inicial de tokens $ethDYDX foi reservada para investidores anteriores da dYdX Trading Inc., fundadores, funcionários, assessores e consultores da dYdX Trading Inc. ou dYdX Foundation, e futuros funcionários e consultores da dYdX Trading Inc. ou dYdX Foundation.

Em 25 de janeiro de 2023, a dYdX Foundation [anunciou](https://www.dydx.foundation/blog/lock-up-extension) uma alteração para adiar a data de lançamento inicial dos tokens $ethDYDX para investidores para 1 de dezembro de 2023. A alteração não modificou o cronograma de desbloqueio escalonado após a data de desbloqueio inicial.

De acordo com a Emenda, os tokens serão liberados das restrições de transferência da seguinte forma:

* 30% em 1 de dezembro de 2023;
* 40% em parcelas mensais iguais de 1 de janeiro de 2024 a 1 de junho de 2024;
