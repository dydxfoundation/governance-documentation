...
![赚取并申领奖励，或对提议进行投票](../.gitbook/4.1-landing-page-interface.png)

### 治理

可以查看正在进行的和过去的治理提议，并且可以对正在进行的治理提议进行投票。

![跟踪提议状况和变更的投票](../.gitbook/4.2-track-proposals.png)

DYDX和stkDYDX的持有人被授予两种治理权：提议权和投票权。通过数据面板，用户可以查看他们的提议权和投票权，并将其委托给其他地址。

![委托您的提议权和投票权](../.gitbook/4.3-delegate-voting.png)

### 质押

用户可以质押DYDX以赚取质押奖励。

<figure><img src="../.gitbook/4.4-stake-funds.png" alt=""><figcaption></figcaption></figure>

### 交易奖励

用户可以在layer 2交易所查看通过交易活动赚取的奖励。交易奖励根据时段时间表每28天进行一次分配。

![交易以获得奖励](../.gitbook/4.5-trade-to-rewards.png)
...
![申领奖励](../.gitbook/4.6-claim-rewards.png)
