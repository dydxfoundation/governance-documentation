...
* Распределение наград за ретроактивный майнинг. Награды можно получить по адресу [**dydx.community**](https://dydx.community) примерно через `8 дней` после окончания эпохи 0.
...
* [Пул стейкинга ликвидности](../staking-pools/liquidity-staking-pool.md) уже доступен в рамках протокола. Этот пул будет работать **примерно до 2 августа 2026 года 15:00:00 по времени в формате UTC** (точная метка времени: 1785682798).
* [Пул стейкинга безопасности](../staking-pools/safety-staking-pool.md) станет автоматически доступен в рамках протокола через несколько дней после окончания эпохи 0, когда будут сняты ограничения на перевод. Этот пул будет работать **примерно до 7 сентября 2026 года 15:00:00 по времени UTC** (точная метка времени: 1788793198).
