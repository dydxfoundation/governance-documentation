...
Заработанные токены $ethDYDX в виде наград за [ретроактивный майнинг](../rewards/retroactive-mining-rewards.md), [наград за торговлю](../rewards/trading-rewards.md) и [наград для поставщиков ликвидности](../rewards/liquidity-provider-rewards.md) можно перевести в конце каждой эпохи. Владельцы $ethDYDX должны подождать примерно `7 дней` (**период ожидания**) после окончания эпохи, чтобы получить свои токены. После получения токены можно перевести или делегировать управлению dYdX.

Токены $ethDYDX, заработанные с помощью пула стейкинга ликвидности и пула стейкинга безопасности, можно получить в каждом блоке и вывести в любое время в течение определенной эпохи.

**8 сентября 2021 года в 15:00:00 по времени в формате UTC**, через 8 дней после окончания эпохи 0, первоначальные ограничения на перевод будут автоматически сняты, и примерно **8,11%** $ethDYDX станут ликвидными.
