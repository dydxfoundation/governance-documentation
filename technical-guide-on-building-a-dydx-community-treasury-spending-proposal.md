...
# Техническое руководство по созданию предложения о расходовании средств, находящихся в кассе сообщества dYdX

Пользователь Reverie подготовил исчерпывающее техническое руководство по представлению предложения по управлению для перевода $ethDYDX из кассы сообщества с помощью запроса на внесение изменений в хранилище _контрактов на управление_ dYdX.
...
3. **Счет GitHub.** Необходим счет GitHub для создания форка хранилища.
