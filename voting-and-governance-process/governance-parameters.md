...
* [Управляющий](governance-parameters.md#governor-parameters)
* Токен DYDX
* Казна
* Дистрибьютор Меркла
...
| Минимальный кворум | Мин. количество положительных голосов, необходимое для принятия предложения | 2% от общего доступного количества | 1% от общего доступного количества | 10% от общего доступного количества | 2% от общего доступного количества |
| Разница в количестве голосов | Требуемая разница в положительных и отрицательных голосах, необходимая для принятия предложения | 0,5% от общего доступного количества | 0,5% от общего доступного количества | 10% от общего доступного количества | 0,5% от общего доступного количества |
| Продолжительность голосования | Период, в течение которого выполняется подсчет голосов | 4 дня | 2 дня | 10 дней | 7 дней |
| Задержка блокировки по времени | Задержка перед исполнением предложения после его принятия и размещения в очереди | 2 дня | 0 дней | 7 дней | 2 дня |
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left">
        <ul>
          <li>Добавление новых адресов в список авторизованных исполнителей</li>
        </ul>
      </td>
...
| Завершение вестинга | Время завершения вестинга | 14 июля 15:00 по времени в формате UTC + 5 лет | 14 июля 15:00 по времени в формате UTC + 5 лет |
...
| Оператор получения | Осуществление получения от лица других участников | Получение доверенности |
...
| :--- | :--- | :--- |
| Начало эпохи ноль | Время начала эпохи ноль | 14 июля 15:00 по времени в формате UTC |
| Завершение распределения наград | Время, когда распределение наград между стейкерами прекращается | 14 июля 15:00 по времени в формате UTC + 5 лет |
| Продолжительность эпохи | Продолжительность каждой эпохи | 28 дней |
...
| Количество наград в секунду | Токены, выдаваемые в качестве наград каждую секунду в период их распределения | 0,1585342262 = \(383 526 / \(28 \* 24 \* 60 \* 60\)\) |
...
| Оператор получения | Осуществление получения от лица других участников | Получение доверенности |
| Оператор стейка | Размещение средств в стейке от имени других | Не распределено |
