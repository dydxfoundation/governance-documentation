...
* [ガバナー](governance-parameters.md#governor-parameters)
* DYDXトークン
* 基金
* Merkleディストリビュータ
* 流動性ステーキング
...
| 最小選択者数 | 提案の審査通過に必要な最小賛成選択数 | 総供給量の2％ | 総供給量の1％ | 総供給量の10％ | 総供給量の2％ |
| 選択数差 | 提案の審査通過には賛成と反対の選択数に差があることが必要です | 総供給量の0.5％ | 総供給量の0.5％ | 総供給量の10％ | 総供給量の0.5％ |
| 選択期間 | 選択数のカウント期間 | 4日間 | 2日間 | 10日間 | 7日間 |
| タイムロックでの遅延時間 | 提案が審査を通過してキューに追加後、実行までの遅延時間 | 2日間 | 0日間 | 7日間 | 2日間 |
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left">
        <ul>
          <li>承認された実行管理者のリストに新しいアドレスを追加します</li>
        </ul>
      </td>
...
| 以前に制限されている譲渡 | 譲渡を可能にする最小タイムスタンプ \(秒単位\) | 7月14日午後3時（UTC世界協定時+28日間+7日間+1日間 |
...
| 基金資金の管理 | 基金の資金を使うことができます | 短いタイムロック | 短いタイムロック |
...
| 基金資金の管理 | 基金の資金を使うことができます | 短いタイムロック | 短いタイムロック | Y |  |  |  |
...
| エポックごとのユーザーの取引報酬 | エポックごとにトレーダーに提供するトークン量 | 383万5616 |
| 流動性プロバイダーのエポックごとの取引報酬 | エポックごとにMMに提供するトークンの量 | 1,150万685 |
| エポック0の遡及報酬 | 遡及報酬に提供するトークンの量 | 7,500万ドル |
