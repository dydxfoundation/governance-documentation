...
由于DYDX是一种可以自由交易的资产，任何人都可以通过交易对购买尝试进行治理接管。也就是说，要强制通过恶意投票，在短时间锁定的情况下至少需要 500 万个 DYDX，在长时间锁定的情况下至少需要 2,000 万个 DYDX。如果不是完全不可能，这一数额将昂贵得令人望而却步，当考虑到价格波动时，其成本可能超过从攻击中获得的净收益。
