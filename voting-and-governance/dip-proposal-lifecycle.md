...
오프체인 DRC가 매우 대략적인 합의에 도달하면, `10,000`DYDX 이상의 제안권을 보유한 커뮤니티 회원은 **스냅샷**에서 DRC를 위한 **오프체인 투표**를 생성할 수 있습니다. 저희는 dYdX 커뮤니티가 정규 근무 주간의 가시성을 높이기 위한 스냅샷 여론조사를 월요일에 실시하도록 장려합니다.
