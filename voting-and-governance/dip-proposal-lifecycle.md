...
스냅샷은 사용자가 오프체인으로 견해를 표명할 수 있는 간단한 투표 인터페이스입니다.
 스냅샷에 대한 투표는 투표에 사용되는 주소에 투표권이 부여됩니다.

동향 알림과 관련된 스냅샷 여론조사의 경우, 제안자는 다음을 제공해야 합니다.

* DRC의 세부 사항,
* 투표 시스템
* 투표 기간 - 투표 시작 날짜 및 투표 종료 날짜 4일의 투표 기간 설정 및
...
* 최소 투표 격차 - 투표의 최소 67%는 제안에 찬성해야 합니다. 최소 투표 격차는 논쟁의 여지가 많은 제안과 추후 논의가 필요한 제안을 필터링하는 데 도움이 됩니다.
