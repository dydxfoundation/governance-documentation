---
description: >-
  Eine schrittweise Übersicht über die Governance-processDRC-Erstellung, die Erstellung der Snapshot-Meinungsumfrage, die Erstellung von DIP, die Abstimmung über die Snapshot-Meinungsumfrage, die Abstimmung über einen DIP, das Hintanstellen eines DIPs und die Ausführung eines DIPs.
---

# Governance-Leitfaden

Die dYdX-Stiftung hat diesen Leitfaden erstellt, um der dYdX-Community zu einem besseren Verständnis der dYdX-Governance-Prozesse zu verhelfen. Der Leitfaden bietet eine schrittweise Übersicht über:
...
* [Durchführung eines DIP (on-chain)](governance-guide.md#how-to-execute-a-proposal)
...
In der Epoche 6 beschloss die dYdX-Community in einer Abstimmung auf [Snapshot](https://commonwealth.im/dydx/snapshot/dydxgov.eth/0x785066561be1e5d170eb28960da5ef2643ee0d0c3d590fd797c028512cc6be43), dass der Schwellenwert des LP-Reward-Volumens für Marktmacher von 1 % auf 0,25 % gesenkt werden sollte. Die Senkung des Schwellenwertes für LP Rewards von 5 % auf 1% in Epoche 2 folgte dem selben Prozess wie bei der Senkung in Epoche 6 (1% auf 0,25 %). Die schrittweise Übersicht darüber, wie der Schwellenwert für das LP Rewards Volumen von 5 % auf 1 % gesenkt wurde, ist im Folgenden eingefügt.

Die Mehrheit der Community (399 Wähler und 86 % der DYDX) beschloss bei der Abstimmung auf [Snapshot](https://forums.dydx.community/snapshot/dydxgov.eth/QmXtS7CGVX7C5v2JdcJpsqWAeZrStQcogSQpP6zzhzwLmN), die Volumenschwelle abzusenken, um die Liquiditiy Provider Rewards von 5 % auf 1 % zu setzen. Ein [off-chain DIP](https://github.com/dydxfoundation/dip/blob/master/content/dips/DIP-2.md) zur Senkung des Schwellenwertes des Liquidity Provider Rewards Volumens für Marktmacher von 5 % auf 1 % wurde von Jacob Goh (jteam0x) von DeFiance Capital eingereicht. Marktmacher, die die Schwelle von 1 % in Epoche 2 erfüllten, waren berechtigt, in Epoche 3 Liquidity Provider Rewards zu erhalten. Der Vorschlag erforderte keine Änderungen im on-chain Smart Contract.

_**Hintergrund:**_

Im Rahmen des Liquidity Provider [Reward-Programmes](https://docs.dydx.community/dydx-governance/rewards/liquidity-provider-rewards) werden 1 150 685 DYDX pro Epoche (28 Tage) an Liquidity Provider, die als Marktmacher für das Protokoll fungieren, ausgeschüttet. Rewards werden auf der Grundlage einer Formel ausgeschüttet, die eine Kombination aus Uptime, Two-sided Depth, Bid-Ask-Spreads und der Anzahl der unterstützten Märkte belohnt. Um für dieses Rewardprogramm in Frage zu kommen, müssen Liquiditätsanbieter in der vorhergehenden Epoche einen Mindestprozentsatz des gesamten Marktmacher-Volumens bereitgestellt haben.
...
Die Community beabsichtigte, den Schwellenwert für Liquidity Provider zu senken, weil somit neue Marktmacher und kleine bis mittlere Marktmacher dazu Anreize bekamen, die Liquidität auf der dYdX-Plattform zu erhöhen. Darüber hinaus trägt eine zunehmende Anzahl von Marktmachern auf der Plattform dazu bei, dass das dYdX-Protokoll dezentraler wird.
...
Der dYdX Governance-Prozess wird von [Governance-Foren](https://forums.dydx.community/) angeheizt. Die Community-Mitglieder posten und kommentieren zu Diskussionsthemen, um  off-chain einen groben Konsens zu erreichen. Weitere Informationen über Forumsdiskussionen und zur DRC-Erstellung finden [Sie hier](https://docs.dydx.community/dydx-governance/voting-and-governance/dip-proposal-lifecycle).

_**Bewerbung auf DIP 2:**_

Su Zhu (zhusu) von Three Arrows Capital hat eine [off-chain Forumsdiskussion](https://forums.dydx.community/proposal/discussion/1805-reduce-market-maker-incentives/) erstellt, um den Schwellenwert für Liquidity Provider Rewards zu senken. Verschiedene Community-Mitglieder, wie Evgeny aus Wintermute, Ben aus Kronos, Josh aus Sixtant und viele mehr, nahmen an der Diskussion teil und trugen mit wertvollen Anregungen bei.
...
![https://forums.dydx.community/new/discussions](<../.gitbook/assets/Untitled 3 (1)>)
...
* Wenn Sie eine DRC erstellen, folgen Sie bitte der [hier](https://github.com/dydxfoundation/dip/blob/master/DIP-X.md) verlinkten Vorlage. Wie unter _DRC-Erstellung_ im [Proposal-Lebenszyklus](https://docs.dydx.community/dydx-governance/voting-and-governance/dip-proposal-lifecycle) beschrieben, müssen die DRCs mindestens Folgendes enthalten:
   ...
   * Der Titel des Forumsbeitrags muss DRC enthalten \[Kurztitel der DRC einfügen] (z.B. DRC: Neue Marktanfrage).
...
Nachdem die Community einen groben Konsens erreicht hat, kann ein Community-Mitglied mit 10K-Vorschlagsrechten, eine off-chain- Abstimmung für die DRC auf [Snapshot](https://snapshot.org/#/) erstellen. [Das Vorschlagsrecht](https://docs.dydx.community/dydx-governance/voting-and-governance/voting) ermöglicht die Ausgestaltung und Aufrechterhaltung eines Vorschlags. Snapshot ist eine einfache Abstimmungsschnittstelle, die es den Benutzern ermöglicht, die Stimmung off-chain zum Ausdruck zu bringen. Die Abstimmungen auf Snapshot werden durch die Anzahl der auf der für die Abstimmung verwendete Adresse gehaltenen oder delegierten DYDX gewichtet. Das Community-Mitglied, das die Snapshot-Umfrage erstellt, muss Details zur DRC, dem Abstimmungssystem, dem Startdatum der Abstimmung, dem Enddatum der Abstimmung sowie der Snapshot-Blocknummer angeben. Die Abstimmungsfrist sollte 5 Tage betragen und die Abstimmung sollte nach einer 1-tägigen Abstimmungsverzögerung beginnen. Die Abstimmungsverzögerung bietet den Community-Mitgliedern Zeit, um mehr über die DRC zu erfahren, DYDX zu kaufen oder die ihre DYDX-Stimmrechte DYDX zu delegieren. Diejenigen Community-Mitglieder, die DYDX halten oden denen Stimmrechte vor der Snapshot-Blocknummer übertragen wurden, sind für die Abstimmung zugelassen. Weitere Informationen über den Snapshot-Umfragen finden Sie [hier](https://docs.dydx.community/dydx-governance/voting-and-governance/dip-proposal-lifecycle) verlinkt.
...
* Registrieren Sie sich auf Snapshot mit Ihrer Ethereum-Wallet und folgen Sie dYdX Proposals [hier](https://snapshot.org/#/dydxgov.eth). Alternativ können Sie an einer Snapshot-Umfrage direkt auf [Commonwealth](https://forums.dydx.community/snapshot/dydxgov.eth) teilnehmen und diese dort erstellen.
...
* Wenn Sie die Mindestleistung an Vorschlagsrechten von 10k erfüllen, wählen Sie „Neuer Vorschlag“ aus und füllen die offenen Felder gemäß den unten aufgeführten Inhaltsbestimmungen aus.
...
* Start- und Enddatum der Abstimmung mit einer Gesamtlänge auf 4 Tage beschränkt, und
...
* In der mit der Fork versehenen DIP-Repo, gehen [Sie](https://github.com/yt8073/dip/tree/master/content/dips) in das Verzeichnis, das den Inhalt der DIPs enthält:
...
Füllen Sie die erforderlichen Informationen aus, wählen Sie das Ropsten Network aus und wählen Sie „App erstellen".
...
DYDX-Inhaber konnten über den DIP abstimmen, als er im Block 13538946 in einen „Aktiven" Zustand überging.
