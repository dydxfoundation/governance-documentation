...
Os detentores de tokens de governança recebem poderes de governança proporcionalmente à soma de seus tokens de propriedade e delegados em um determinado bloco.
...
`Poder de proposta do $ethDYDX delegado -`

`Poder de proposta do $wethDYDX delegado -`

`Poder de proposta do $stkDYDX delegado`
...
A governança da dYdX permite que os titulares deleguem os direitos de voto para o endereço de sua escolha. Qualquer pessoa pode participar da governança da dYdX recebendo a delegação, sem precisar possuir tokens de governança. Os usuários podem delegar a um endereço de cada vez, e a quantidade de votos adicionados à contagem de votos do delegado é equivalente ao saldo de tokens de governança na conta do usuário. Os votos são delegados a partir do bloco atual e adiante, até que os tokens de governança sejam delegados ou transferidos novamente pelo remetente.

![Delegar seus poderes de votação e de proposta](../.gitbook/assets/1-delegate-power.png)
...
Os detentores de tokens podem delegar o poder de proposta e de votação para diferentes endereços. No entanto, não há uma delegação parcial (apenas 100% ou 0% de poder).
...
* Digite um endereço de carteira para um terceiro a quem você gostaria de delegar seu poder de votação e/ou de proposta. Os poderes de delegação não transferem seus tokens
...
Após um voto ter sido feito on-chain, não é possível alterá-lo.
